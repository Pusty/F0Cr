...
public class InstLocalVar extends Instruction {
	...
	public InstLocalVar(InstructionReader reader, byte inst, byte[] data) {
		...
		if(!isInst(inst) && (inst&0xFF) != Opcodes.WIDE) {System.err.println("Error: Created LocalVar instruction with OpCode: "+inst+" => " +Opcodes.getName(inst));}
		cla = setType();
		if(cla == Array.class)
			ref=true;
		var = setVariable();
	...
	public boolean setBool() {
		...
		case Opcodes.WIDE:
			...
			case Opcodes.FLOAD:
			case Opcodes.DLOAD:
			case Opcodes.ALOAD: return true;
			case Opcodes.ISTORE:
			case Opcodes.LSTORE:
			case Opcodes.FSTORE:
			case Opcodes.DSTORE:
			case Opcodes.ASTORE: return false;
	...
	public Class<?> setType() {
		...
		case Opcodes.WIDE:
			...
			case Opcodes.FLOAD: return float.class;
			case Opcodes.DLOAD: return double.class;
			case Opcodes.ALOAD: return Array.class;
			case Opcodes.ISTORE: return int.class;
			case Opcodes.LSTORE: return long.class;
			case Opcodes.FSTORE: return float.class;
			case Opcodes.DSTORE: return double.class;
			case Opcodes.ASTORE: return Array.class;
			default: return null;
			}
